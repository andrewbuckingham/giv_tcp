...
import time, sys, importlib, time, os
...
if USE_NEW_CACHE:
    ...
    logger.info("MQTT Client: Using new PickleCacheRepository for cache operations")
else:
    cache_repo = None
    logger.info("MQTT Client: Using legacy pickle operations for cache")
